...
public class JoystickView extends SurfaceView implements SurfaceHolder.Callback, View.OnTouchListener {
    ...
    private void drawJoystick(float newX, float newY)
    {
        if(getHolder().getSurface().isValid())
        {
            ...
            //myCanvas.drawARGB(255,0,0,255); // con esta linea tambien puedo controlar el color mas especificamente usando el rgb y alfa
            colors.setARGB(255,50,50,50); //colors.setARGB(int alpha,int red, int green, int blue); // colors of joystick itself
            myCanvas.drawCircle(centerX, centerY, baseRadius, colors); // Draw the joystick hat ( the ball of the top)
